...
void main()
{
	...
	outBlock[gl_InvocationID].worldPosition = inBlock[gl_InvocationID].worldPosition;
    outBlock[gl_InvocationID].screenPosition = inBlock[gl_InvocationID].screenPosition;
	...
	gl_TessLevelInner[0] = outTessLevel;
    gl_TessLevelInner[1] = outTessLevel;
}