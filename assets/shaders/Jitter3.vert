...
layout(binding = 6) uniform upJitterSettings
{
	ivec2 points[4];
};
...
void main()
{
	...
	vec2 jitter = points[index] * vec2(deltaWidth, deltaHeight);
	...
	jitterm[2][0] += jitter.x;// * haltonScale;
	jitterm[2][1] += jitter.y;// * haltonScale;
